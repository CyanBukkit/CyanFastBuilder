...
public class BoardOldVerHardle implements BoardInstance {
    ...
    public BoardOldVerHardle(Player owner) {
        this.owner = owner;
        //this.title = title;
        ...
        this.lines.stream().map(BoardOldVerHardle::color).forEach(this.sideline::add);
        this.sideline.flush();
    }
    ...
    public void send(Collection<String> lines) {
        lines.stream().map(BoardOldVerHardle::color).forEach(this.sideline::add);
        this.sideline.flush();
    }
